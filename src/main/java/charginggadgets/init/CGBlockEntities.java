...
public class CGBlockEntities {
    ...
    public static final BlockEntityType<ChargingStationBlockEntity> CHARGING_STATION = register(ChargingStationBlockEntity::new, "charge_o_mat", CGContent.Machine.CHARGING_STATION);
